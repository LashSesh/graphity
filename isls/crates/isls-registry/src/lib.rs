...
/// A single registry entry (ISLS Extension Def 1)
#[derive(Clone, Debug, Serialize, Deserialize)]
...
/// Content-addressed, append-only collection of registry entries (ISLS Extension Def 2)
#[derive(Clone, Debug, Serialize, Deserialize)]
pub struct Registry {
...
/// Tuple of all four registries (ISLS Extension Def 3)
#[derive(Clone, Debug, Serialize, Deserialize)]
