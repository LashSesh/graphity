...
pub fn build_crystal_with_id(
    region: Vec<isls_types::VertexId>,
    stability_score: f64,
    created_at: isls_types::CommitIndex,
    free_energy: f64,
    carrier_instance_idx: usize,
    constraint_program: isls_types::ConstraintProgram,
    commit_proof: isls_types::CommitProof,
) -> SemanticCrystal {
...
mod tests {
    use super::*;
    use isls_types::{CommitProof, GateSnapshot, ConsensusResult};
